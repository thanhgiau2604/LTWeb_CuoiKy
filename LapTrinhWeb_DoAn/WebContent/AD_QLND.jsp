...
<head>
	...
	<!-- css file -->
	<link rel="stylesheet" type="text/css" href="file/css/QLND.css">
</head>
<body>
		...
		<div class="container">
			<div class="row noidung">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center qlnd">
					<h2>QUẢN LÝ NGƯỜI DÙNG</h2>
				</div>
				<div class="row quanly">
					<div class="col-xs-5 col-sm-4 col-md-4 col-lg-4 col-md-push-2 col-xs-push-1 boxthumbnail">
						<div class="preview_outer wow fadeIn" data-wow-delay="300ms">
							<div class="thumbnail text-center">
								<img src="file/Images/thisinh.png" width="70%" alt="" >
								<div class="overlay">
									<h3 style="color: white">Quản lý thí sinh</h3>
									<a href="AD_QLND_DS.jsp" class="btn btn-primary nutclick">Chọn</a>
								</div>
								<h3 class="caption">Quản lý thí sinh</h3>	
							</div>	
						</div>
					</div>
					<div class="col-xs-5 col-sm-4 col-md-4 col-lg-4 col-md-push-2 col-xs-push-1 boxthumbnail">
						<div class="preview_outer wow fadeIn" data-wow-delay="300ms">
							<div class="thumbnail text-center">
								...
								<div class="overlay">
									<h3 style="color: white">Quản lý giáo viên</h3>
									<a href="AD_QLND_DS.jsp" class="btn btn-primary nutclick nutgv">Chọn</a>
								</div>	
								<h3 class="caption">Quản lý giáo viên</h3>	
							</div>
						</div>
					</div>
				</div>
