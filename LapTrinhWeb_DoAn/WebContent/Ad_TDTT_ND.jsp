		...
		<div class="container">
			<div class="posTDTT text-center">
				...
				<%
					...
					while (rs.next()){
				%>
				<form action="ServletThayDoiTTNguoiDung" method="post" id="formtdtt">
					<div class="pom-agile">
					...
					<div class="pom-agile">
						...
						<input  name="mkc2" class="Infor" type="password" value="<%out.print(rs.getString(3));%>" style="margin-left:60px" readonly="true">
