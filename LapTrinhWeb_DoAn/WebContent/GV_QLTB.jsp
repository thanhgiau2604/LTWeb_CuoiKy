...
<body data-spy="scroll" data-target=".navbar-fixed-top" data-offset="90">
		...
		<%
			...
			ResultSet rs = tb.LayDanhSachThongBaoGV(TenDN);
		%>
	<div class="container">
						...
						<table class="table table-bordered">
							...
							%>
								<tr>
									...
									<td><div class="btn btn-success nutXem"><a href="GV_XemTB.jsp?id=<%out.print(rs.getString(1)); %>" >Xem</a></div></td>
									<td>
										<div class="btn btn-danger nutXoa" >
										<a href="ServletGV_ThongBao?id=<%=rs.getString(1)%>">Xóa</a></div>
									</td>
								</tr>
								<%
									}
           ...
           <%
				...
				ResultSet rs1 = tb1.LayDanhSachThongBaoGVNhan();
			%>
						...
						<table class="table table-bordered">
							...
							%>
								<tr>
									...
									<td><div class="btn btn-success nutXem"><a href="GV_XemTB.jsp?id=<%out.print(rs1.getString(1)); %>">Xem</a></div></td>
								</tr>
								<%
									}
								%>
