...
<body data-spy="scroll" data-target=".navbar-fixed-top" data-offset="90">
		...
		<div class="sub-main-w3">	
			...
			<form action="#" method="post" id="formdangnhap">
				<div class="pom-agile">
					<input placeholder="Tên đăng nhập" name="username" class="user" type="text" required="">
				...
				<div class="sub-w3l">
					<h6>Chưa có tài khoản? <a href="Guest_DangKy.jsp" class="dky">Đăng ký ngay</a></h6> 
					<h6><a href="Guest_QuenMatKhau.jsp">Quên mật khẩu?</a></h6>
					<div class="right-w3l">
						<input type="submit" value="Đăng nhập"> </br> 
						<div class="btn btn-danger"><a href="TrangChuTS.jsp"
							style="text-decoration: none; color: white">Thí sinh</a></div> 
						<div class="btn btn-danger"><a href="TrangChuGV.jsp" 
							style="text-decoration: none; color: white">Giáo viên</a></div> 
						<div class="btn btn-danger"><a href="TrangChuAdmin.jsp" 
							style="text-decoration: none; color: white">Admin</a></div> 
					</div>
				</div>
			</form>
		</div>
