...
<!-- 					<a href="#" class="tl-intro-wrapper bg-yellow"> <span -->
<!-- 						class="intro-icon"> <i class="fa fa-question"></i> -->
<!-- 					</span> Intro Icon End -->
...
<!-- 					<a href="#" class="tl-intro-wrapper bg-green"> <span -->
<!-- 						class="intro-icon"> <i class="fa fa-list-ol"></i> -->
<!-- 					</span> Intro Icon End -->
<!-- 						<div class="intro-content"> -->
...
<!-- 					<a href="#" class="tl-intro-wrapper bg-orange"> <span -->
<!-- 						class="intro-icon"> <i class="fa fa-eye"></i> -->
<!-- 					</span> Intro Icon End -->
<!-- 						<div class="intro-content"> -->
...
<!-- 						<p class="wow fadeIn"> -->
<!-- 							Nếu bạn có niềm đam mê kiến thức hoặc đang chuẩn bị ôn luyện kiến -->
<!-- 							thức để kiểm tra hay thi cử thì website thi trắc nghiệm của chúng -->
<!-- 							tôi sẽ là một lựa chọn đúng đắn. Bởi lẽ, đến với website bạn -->
<!-- 							không những được trải nghiệm với những đề thi cực hot do giáo -->
<!-- 							viên tạo mà hệ thống còn bổ sung những đề thi được cập nhật liên -->
<!-- 							tục về những kiến thức mới nhất. Còn chờ gì nữa, hãy ghi danh với -->
<!-- 							chúng tôi <a href="">tại đây</a>. Chúng tôi sẽ tích cực hỗ trợ -->
<!-- 							bạn! -->
<!-- 						</p> -->
...
<!-- 						</div> -->
<!-- 						<div> -->
<!-- 							<p>Để đạt kết quả tốt nhất trong việc học tập, chúng ta phải -->
<!-- 								biết kết hợp giữa việc học tập và giảng dạy trên ghế nhà trường -->
<!-- 								với với việc ôn luyện trực tuyến và đó cũng chính là việc kết -->
<!-- 								hợp hiệu quả giữa lý thuyết và thực hành!</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 					About Content end -->
<!-- 				</div> -->
...
<!-- 								<span class="event-date">20</span> <span class="event-month">July</span> -->
<!-- 							</div> -->
<!-- 							Event Time End -->
<!-- 							<div class="event-info"> -->
<!-- 								<h5 class="event-name"> -->
<!-- 									<a href="">Phương pháp học tập hiệu quả</a> -->
<!-- 								</h5> -->
<!-- 								<p class="event-desc">We ever undertakes laborious physical -->
<!-- 									exercise, except to obtain some..</p> -->
<!-- 							</div> -->
<!-- 							Event Info end -->
<!-- 						</div> -->
<!-- 						Event Box End -->
<!-- 						<div class="event-box-wrapper"> -->
<!-- 							<div class="event-time"> -->
<!-- 								<span class="event-date">10</span> <span class="event-month">Aug</span> -->
<!-- 							</div> -->
<!-- 							Event Time End -->
<!-- 							<div class="event-info"> -->
<!-- 								<h5 class="event-name"> -->
<!-- 									<a href="">Kì thi THPT quốc gia 2019</a> -->
<!-- 								</h5> -->
<!-- 								<p class="event-desc">We ever undertakes laborious physical -->
<!-- 									exercise, except to obtain some..</p> -->
<!-- 							</div> -->
...
<!-- 						<div class="event-box-wrapper""> -->
<!-- 							<div class="event-time"> -->
<!-- 								<span class="event-date">04</span> <span class="event-month">Sep</span> -->
<!-- 							</div> -->
<!-- 							Event Time End -->
<!-- 							<div class="event-info"> -->
<!-- 								<h5 class="event-name"> -->
<!-- 									<a href="">Bảo trì nâng cấp Server</a> -->
<!-- 								</h5> -->
<!-- 								<p class="event-desc">We ever undertakes laborious physical -->
<!-- 									exercise, except to obtain some..</p> -->
<!-- 							</div> -->
...
<!-- 		Container end -->
<!-- 	</section> -->
<!-- 	About Area End end welcome + baidang gioithieu -->
...
<!-- 				<div -->
<!-- 					class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-push-1 text-justify"> -->
<!-- 					<p class="modau">Ngành công nghiệp hóa đất nước nói chung và -->
<!-- 						ngành giáo dục nói riêng ngày càng phát triển. Vì thế, nhu cầu -->
<!-- 						phát triển tri thức của con người ngày càng cao, trong đó có cả -->
<!-- 						học sinh, giáo viên và những tổ chức giáo dục. Website thi trắc -->
<!-- 						nghiệm trực tuyến được lên ý tưởng thiết kế cũng dựa trên nhu cầu -->
<!-- 						cần thiết ấy.</p> -->
<!-- 				</div> -->
<!-- 			</div> -->
<!-- 			<div class="row"> -->
...
<!-- 							<a href="#"> <img src="file/Images/yt.jpg" alt="intro thumb" -->
<!-- 								width="100%"> -->
<!-- 							</a> -->
<!-- 						</div> -->
<!-- 						<div class="item-txt text-center f1"> -->
<!-- 							<h3 class="fw-6">Về ý tưởng</h3> -->
<!-- 							<p>Dựa trên nhu cầu học tập và giảng dạy của sinh viên và -->
<!-- 								giáo viên trong và ngoài nhà trường.</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 				<div class="col-xs-0 col-sm-0 col-md-1 col-lg-1"></div> -->
...
<!-- 					<div class="item"> -->
<!-- 						<div class="item-thumb"> -->
<!-- 							<a href="#"> <img src="file/Images/aim.png" alt="intro thumb" -->
<!-- 								width="100%"> -->
<!-- 							</a> -->
<!-- 						</div> -->
<!-- 						<div class="item-txt text-center f1"> -->
<!-- 							<h3 class="fw-6">Về mục đích</h3> -->
<!-- 							<p>Giúp sinh viên ôn tập và bổ sung kiến thức, giúp giáo viên -->
<!-- 								tiết kiệm thời gian, công sức.</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 			</div> -->
<!-- 			<p style="padding-bottom: 13px">Đến với website, chúng tôi có thể -->
<!-- 				khiến bạn yên tâm về:</p> -->
<!-- 			<div class="row"> -->
<!-- 				tính chính xác -->
<!-- 				<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3"> -->
<!-- 					<div class="item"> -->
<!-- 						<div class="item-thumb"> -->
<!-- 							<a href="#"> <img src="file/Images/exactly.jpg" -->
<!-- 								alt="intro thumb" width="100%"> -->
<!-- 							</a> -->
<!-- 						</div> -->
<!-- 						<div class="item-txt text-center f1 tinhchat1"> -->
<!-- 							<h3 class="fw-6">Tính chính xác</h3> -->
<!-- 							<p>Website hoạt động chính xác trong việc đưa tra kết quả của -->
<!-- 								các thao tác đưa đến người dùng.</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 				tính hiệu quả -->
...
<!-- 					<div class="item"> -->
<!-- 						<div class="item-thumb"> -->
<!-- 							<a href="#"> <img src="file/Images/Effective.gif" -->
<!-- 								alt="intro thumb" width="100%"> -->
<!-- 							</a> -->
<!-- 						</div> -->
<!-- 						<div class="item-txt text-center f1 tinhchat2"> -->
<!-- 							<h3 class="fw-6">Tính hiệu quả</h3> -->
<!-- 							<p>Thao tác thực hiện nhanh chóng, hiệu quả, hỗ trợ học sinh, -->
<!-- 								sinh viên, giáo viên trong việc dạy và học.</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 				tính tiện dụng -->
...
<!-- 					<div class="item"> -->
<!-- 						<div class="item-thumb"> -->
<!-- 							<a href="#"> <img src="file/Images/easy.jpg" -->
<!-- 								alt="intro thumb" width="100%"> -->
<!-- 							</a> -->
<!-- 						</div> -->
<!-- 						<div class="item-txt text-center f1 tinhchat3"> -->
<!-- 							<h3 class="fw-6">Tính tiện dụng</h3> -->
<!-- 							<p>Giao diện website được thiết kế đơn giản, dễ dàng quan -->
<!-- 								sát, các tính năng đơn giản dễ sử dụng.</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 				tính tương thích -->
...
<!-- 					<div class="item"> -->
<!-- 						<div class="item-thumb"> -->
<!-- 							<a href="#"> <img src="file/Images/tuongthich.gif" -->
<!-- 								alt="intro thumb" width="100%"> -->
<!-- 							</a> -->
<!-- 						</div> -->
<!-- 						<div class="item-txt text-center f1 tinhchat4"> -->
<!-- 							<h3 class="fw-6">Tính tương thích</h3> -->
<!-- 							<p>Website hoạt động được trên nhiều thiết bị. Người dùng có -->
<!-- 								thể dùng trên PC, laptop, table, điện thoại.</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 			</div> -->
...
<!-- 				</br> -->
<!-- 				<div class="khungcn"> -->
<!-- 					<span class="cntext"> Về chức năng của webiste: </span> -->
<!-- 				</div> -->
<!-- 				<div class="detail"> -->
<!-- 					<div class="row"> -->
...
<!-- 							<p> -->
<!-- 								Website được phân chia thành 4 quyền truy cập: khách, giáo viên, -->
<!-- 								thí sinh, admin. Mỗi quyền truy cập có những chức năng khác -->
<!-- 								nhau. Chi tiết một số chức năng chính được thể hiện <a href="#">tại -->
<!-- 									đây</a>. -->
<!-- 							</p> -->
<!-- 						</div> -->
<!-- 					</div> -->
...
<!-- 								<span class="luuy">Bạn được sử dụng chức năng chính của -->
<!-- 									website chỉ khi được là thành viên của website, bạn có thể đăng -->
<!-- 									ký thành viên <a href="">tại đây</a>, nếu đã có tài khoản bạn -->
<!-- 									có thể <a href="">đăng nhập</a>. -->
<!-- 								</span> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</div> -->
...
<!-- 								<p>Bạn có thể thêm, sửa, xóa các câu hỏi cho ngân hàng câu -->
<!-- 									hỏi của mình.</p> -->
...
<!-- 								<p>Bạn có thể thêm, sửa, xóa các đề thi cho danh cách đề thi -->
<!-- 									đã tạo.</p> -->
<!-- 								</br> -->
<!-- 								<p> -->
...
<!-- 							<div class="caption"> -->
<!-- 								<h3>Quản lý điểm</h3> -->
<!-- 								<p>Bạn có thể xem điểm, tìm kiếm thí sinh và lọc danh sách -->
<!-- 									điểm theo nhiều tiêu chí khác nhau.</p> -->
...
<!-- 							<div class="caption"> -->
<!-- 								<h3>Vào thi</h3> -->
<!-- 								<p>Bạn có thể thi tất cả các đề thi có trong hệ thống.</p> -->
<!-- 								</br> -->
<!-- 								<p> -->
<!-- 									<a href="#" class="btn btn-primary nutct">Chi tiết</a> -->
<!-- 								</p> -->
...
<!-- 								<p>Sau khi hoàn thành bài thi, bạn có thể xem lại để kiểm -->
<!-- 									tra bài làm của mình.</p> -->
<!-- 								<p> -->
<!-- 									<a href="#" class="btn btn-primary nutct">Chi tiết</a> -->
<!-- 								</p> -->
<!-- 							</div> -->
...
<!-- 							<div class="caption"> -->
<!-- 								<h3>Gửi phản hồi</h3> -->
<!-- 								<p>Nếu có thắc mắc với kết quả bài thi, bạn có thể gửi phản -->
<!-- 									hồi trực tiếp với giáo viên đã tạo bài thi.</p> -->
<!-- 								<p> -->
