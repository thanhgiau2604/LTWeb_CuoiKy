...
<head>
	...
	<!-- jquery -->
	<script type="text/javascript" src="file/js/jqDoiMK.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="file/css/Ad_DoiMatKhau.css">
</head>
<body>
			...
			<div class="container dt" id="idtrangchu">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right menu">
						<li ><a class="btnTC" href="TrangChuAdmin.jsp">TRANG CHỦ</a></li>
