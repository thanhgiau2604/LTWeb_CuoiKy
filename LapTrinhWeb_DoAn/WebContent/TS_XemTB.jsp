				...
				<div class="col-md-10 col-sm-12 col-xs-12 col-md-push-1">
					<form method="post" id="formthemtb">
						...
						<div class="form-group ">
							...
							<input class="form-control" id="text1" name="nguoitao" placeholder="Người gửi" type="text" value="<%out.print(rs.getString(8));%>"/>
						</div>
						<%
							}
						%>
						<div class="form-group nutsubmit">
							<div>
								<button class="btn btn-primary btnsubmit" name="submit" type="submit" formaction="TS_ThongBao.jsp">
									Quay về
								</button>
							</div>
						</div>
